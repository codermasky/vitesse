      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-4 text-surface-500 font-medium">Loading integrations...</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-24 h-24 bg-surface-100 dark:bg-surface-900 rounded-3xl flex items-center justify-center mb-6">
              <Zap className="w-10 h-10 text-surface-400" />
            </div>
            <h3 className="text-xl font-bold text-surface-950 dark:text-white mb-2">No Integrations Found</h3>
              ...
              {filteredIntegrations.map((integration) => {
                ...
                return (
                  <motion.div
                    ...
                    whileHover={{ y: -5 }}
                    className="group relative bg-white dark:bg-surface-900 border border-surface-200 dark:border-white/5 rounded-3xl p-6 hover:shadow-2xl hover:shadow-brand-500/10 transition-all duration-300 cursor-pointer"
                    onClick={() => setSelectedIntegration(integration)}
                  >
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-surface-50 dark:bg-surface-800 flex items-center justify-center text-brand-500 border border-surface-100 dark:border-white/5 group-hover:bg-brand-500 group-hover:text-white transition-all duration-300">
                          <Zap className="w-6 h-6" />
                        </div>
                        <div>
                          <h3 className="font-bold text-lg text-surface-950 dark:text-white group-hover:text-brand-500 transition-colors line-clamp-1">
                            {integration.name}
                          </h3>
                      ...
                      <div className={cn(
                        "px-3 py-1.5 rounded-xl border text-[10px] font-black uppercase tracking-wider flex items-center gap-2 bg-white dark:bg-surface-950",
                        statusConfig_.color,
                    ...
                    <div className="flex items-center gap-3 mb-6 p-4 bg-surface-50 dark:bg-black/20 rounded-2xl border border-surface-100 dark:border-white/5">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-surface-100 dark:border-white/5">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-medium text-surface-500 bg-surface-100 dark:bg-white/10 px-2 py-1 rounded-lg">
                          {integration.deployment_target}
                        </span>
                      </div>
                      <button
                        className="opacity-0 group-hover:opacity-100 transition-opacity p-2 hover:bg-surface-100 dark:hover:bg-white/10 rounded-lg text-brand-500 font-bold text-xs flex items-center gap-1"
                        onClick={(e) => {
                          e.stopPropagation();
      ...
      <AnimatePresence>
        {selectedIntegration && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 bg-surface-950/60 backdrop-blur-md flex items-center justify-center p-4"
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-surface-900 rounded-3xl max-w-2xl w-full shadow-2xl overflow-hidden border border-surface-200 dark:border-white/10"
            >
              <div className="p-8 pb-0">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <button
                    onClick={() => setSelectedIntegration(null)}
                    className="p-2 hover:bg-surface-100 dark:hover:bg-white/10 rounded-xl transition-colors"
                  >
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-surface-50 dark:bg-black/20 rounded-2xl border border-surface-100 dark:border-white/5">
                ...
                {selectedIntegration.health_score && (
                  <div className="mb-8">
                    <h3 className="text-sm font-black text-surface-950 dark:text-white uppercase tracking-wider mb-4">
                      Health Metrics
                    </h3>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="p-4 bg-surface-50 dark:bg-white/5 rounded-2xl text-center">
                      ...
                      <div className="p-4 bg-surface-50 dark:bg-white/5 rounded-2xl text-center">
                        ...
                        <p className="text-xl font-black text-surface-900 dark:text-white">45ms</p>
                      </div>
                      <div className="p-4 bg-surface-50 dark:bg-white/5 rounded-2xl text-center">
              ...
              <div className="bg-surface-50 dark:bg-black/20 p-6 border-t border-surface-200 dark:border-white/5 flex gap-3">
                <button
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-white dark:bg-surface-800 hover:bg-surface-50 dark:hover:bg-surface-700 text-surface-900 dark:text-white rounded-xl font-bold border border-surface-200 dark:border-white/10 transition-all flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="px-4 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-600 rounded-xl font-bold border border-red-500/10 transition-all"
                >
      ...
      <AnimatePresence>
        {showDeleteModal && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-surface-950/60 backdrop-blur-md z-[60] flex items-center justify-center p-4"
          >
            <motion.div
            ...
            >
              ...
              <h2 className="text-xl font-black text-surface-950 dark:text-white mb-2">Delete Integration?</h2>
